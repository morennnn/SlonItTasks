/* Задание 12. Подготовьте простой калькулятор simpleCalculate, который будет выполнять нужную операцию из четырех стандартных: +-. Без использования операторов ветвления (if/else). 
